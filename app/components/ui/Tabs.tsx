...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={classNames(
      'inline-flex h-10 items-center justify-center bg-[var(--surface-1)] border-b border-[var(--border-subtle)]',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={classNames(
      ...
      'data-[state=active]:text-[var(--text-primary)] data-[state=active]:border-b-2 data-[state=active]:border-[var(--accent)]',
      className,
    )}
    {...props}
  />
