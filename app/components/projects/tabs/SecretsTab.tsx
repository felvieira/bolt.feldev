    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="rounded-lg overflow-hidden" style={{ border: '1px solid var(--border-subtle)' }}>
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={3} className="px-4 py-6 text-center" style={{ color: 'var(--text-tertiary)' }}>
                  Loading...
                </td>
              </tr>
            ) : secrets.length === 0 ? (
              ...
              secrets.map((secret) => (
                <tr key={secret.key} style={{ borderTop: '1px solid var(--border-subtle)' }}>
      ...
      <div className="flex gap-3 items-end">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium text-white transition-opacity disabled:opacity-50 shrink-0"
