...
export default function VercelConnection() {
  ...
  return (
    <motion.div
      className="bg-[#0A0A0A] rounded-lg border border-[#E5E5E5] dark:border-[#1A1A1A]"
                    ...
                    {connection.stats.projects.map((project) => (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          {project.framework && (
                            <div className="text-xs text-bolt-elements-textSecondary px-2 py-1 rounded-md bg-[#252525]">
                              <span className="flex items-center gap-1">
