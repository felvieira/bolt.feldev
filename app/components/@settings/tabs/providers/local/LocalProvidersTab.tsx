      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--accent)]/20 to-blue-500/20 flex items-center justify-center ring-1 ring-[var(--accent)]/30">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-bolt-elements-background-depth-2 hover:bg-bolt-elements-background-depth-3 border-bolt-elements-borderColor hover:border-[var(--accent)]/30 transition-all duration-200 gap-2"
              >
                ...
                <Card className="mt-4 bg-bolt-elements-background-depth-2">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <PackageOpen className="w-5 h-5 text-[var(--accent)]" />
                    ...
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="bg-gradient-to-r from-[var(--accent)]/8 to-[var(--accent)]/8 hover:from-[var(--accent)]/15 hover:to-[var(--accent)]/15 border-[var(--accent)]/25 hover:border-[var(--accent)]/40 transition-all duration-300 gap-2 group shadow-sm hover:shadow-md font-medium"
                          _asChild
                        >
                          <a
                            href="https://ollama.com/library"
