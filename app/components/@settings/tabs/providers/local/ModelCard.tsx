...
function ModelCard({ model, onUpdate, onDelete }: ModelCardProps) {
  return (
    <Card className="bg-bolt-elements-background-depth-3 hover:bg-bolt-elements-background-depth-4 transition-all duration-200 shadow-sm hover:shadow-md border border-bolt-elements-borderColor hover:border-[var(--accent)]/20">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={classNames(
                ...
                'bg-[var(--accent-muted)] text-[var(--accent)] hover:bg-[var(--accent-muted)] hover:shadow-sm',
                'disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[var(--accent-muted)]',
              )}
            >
