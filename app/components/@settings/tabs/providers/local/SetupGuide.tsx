...
function SetupGuide({ onBack }: { onBack: () => void }) {
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-[var(--accent)]/10 border border-blue-500/20 shadow-sm">
      ...
      <Card className="bg-bolt-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--accent)]/20 to-[var(--accent)]/20 flex items-center justify-center ring-1 ring-[var(--accent)]/30">
            ...
            <span className="px-3 py-1 bg-[var(--accent-muted)] text-[var(--accent)] text-xs font-medium rounded-full">
              Recommended
            </span>
          </div>
        </CardHeader>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-bolt-elements-background-depth-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full bg-gradient-to-r from-[var(--accent)]/10 to-[var(--accent)]/10 hover:from-[var(--accent)]/20 hover:to-[var(--accent)]/20 border-[var(--accent)]/30 hover:border-[var(--accent)]/50 transition-all duration-300 gap-2 group shadow-sm hover:shadow-lg hover:shadow-[var(--accent)]/20 font-medium"
                    _asChild
                  >
                    <a
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-[var(--accent)]/5 border border-[var(--accent)]/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-medium text-[var(--accent)]">Performance Optimized</span>
                </div>
      ...
      <Card className="bg-gradient-to-r from-[var(--accent)]/10 to-pink-500/10 border border-[var(--accent)]/20 shadow-sm">
